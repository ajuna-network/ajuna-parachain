...
pub fn template_session_keys(keys: AuraId) -> ajuna_runtime::SessionKeys {
	ajuna_runtime::SessionKeys { aura: keys }
}

pub fn ajuna_chain_spec(
	para_id: ParaId,
	...
	.with_name(&format!("Ajuna {}", relay_chain.name()))
	.with_id(&format!("ajuna-{}", relay_chain.id()))
